...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native PyramidGame initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this pyramidgame : https://thecodingmachine.github.io/react-native-pyramidgame/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-pyramidgame/issues'
			);
			console.log(
				'- ⭐ If you love this pyramidgame, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-pyramidgame'
			);
